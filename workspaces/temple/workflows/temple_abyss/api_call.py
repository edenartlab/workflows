    ...
    def create_image(self, prompt):
        payload = {
            ...
            "args": {
                ...
                "rendered_art_image": "https://edenartlab-lfs.s3.us-east-1.amazonaws.com/comfyui/models2/assets/temple_abyss_sanitized/steve.png",
                "background_image": "https://edenartlab-lfs.s3.us-east-1.amazonaws.com/comfyui/models2/assets/temple_abyss_sanitized/RareSuperRareTealDesign2422x.png",
                "clan_icon": "https://edenartlab-lfs.s3.us-east-1.amazonaws.com/comfyui/models2/assets/temple_abyss_sanitized/grey-ultra-rare-clan-badge_1.png.png",
                "rarity_icon": "https://edenartlab-lfs.s3.us-east-1.amazonaws.com/comfyui/models2/assets/temple_abyss_sanitized/ultra-rare-jade422x.png",
                "aura_icon": "https://edenartlab-lfs.s3.us-east-1.amazonaws.com/comfyui/models2/assets/temple_abyss_sanitized/aura-point-icon422x.png",
                "init_image": "https://edenartlab-lfs.s3.us-east-1.amazonaws.com/comfyui/models2/assets/temple_abyss_sanitized/steve.png",
                "card_name": "STEVE",
