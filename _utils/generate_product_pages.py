...
if __name__ == "__main__":
    ...
    task_description = """Task: Create an SEO-Optimized Product Page for an AI Tool
Objective:
Create a compelling, user-friendly product page that showcases one of Eve's (our autonomous creative assistant) capabilities, based on the provided API interaction pattern (api.yaml). 
The page should be accessible to non-technical users while effectively communicating the tool's value and practical applications.
Key Requirements:

Format: Write in markdown
Target Audience: Non-technical users seeking AI solutions
SEO Focus: Optimize for search engine discovery and user intent
Integration Context: Present as one component of Eve's broader capabilities

Required Sections:

Engaging title
Brief, clear introduction to the tool
Key features list
Representative use cases/examples (you can add media placeholders for later population with visual examples)
Practical applications and problem-solving scenarios in which this tool can be used

Content Guidelines:

Transform technical API descriptions into user-friendly explanations
Minimize technical jargon; focus on practical benefits
...
Serve as both a discovery tool and a practical usage template
...
Position as part of a larger AI solution suite (Eve)
Focus on user benefits and practical applications
Make complex capabilities accessible through real-world examples
Drive organic search traffic through problem-solution focused content

Expected Input:

API specification/documentation in YAML format containing tool description and parameter details

The final product should transform technical API documentation into engaging marketing content that functions as both a promotional asset and a practical guide, 
